...
sl_simple_button_context_t simple_instance0_context = {
  .state = 0,
  .history = 0,
  .port = SL_SIMPLE_BUTTON_INSTANCE0_PORT,
  .pin = SL_SIMPLE_BUTTON_INSTANCE0_PIN,
  .mode = SL_SIMPLE_BUTTON_INSTANCE0_MODE,
};

const sl_button_t sl_button_instance0 = {
  .context = &simple_instance0_context,
